...
│        尚未完成（~25% → ~5%，技術可行）                │
│                                                      │
│  句式多樣性 SFT 數據 ✅ ← 定點改寫 131 turns, ICF 3.83    │
...
**累計最終成績（ICF 3.10 → 3.83，+23.5%）**：

| 維度 | Baseline | 最終（SFT v5c + DPO v2c + v4 prompt + Monitor + Critic） | 改善 |
|------|---------|----------------------------------------------------------|------|
| Trust & Safety | 3.40 | **3.80** | **+0.40** |
| Coaching Presence | 2.57 | **3.70** | **+1.13** |
| Active Listening | 3.10 | **3.70** | **+0.60** |
| Evokes Awareness | 3.33 | **4.10** | **+0.77** |
| **Overall** | **3.10** | **3.83** | **+0.73 (+23.5%)** |
| Sessions ≥ 4.2/5.0 | 0/10 | **4/10** | S6=5.0, S3/S4=4.8, S10=4.2 |
