...
SCENARIOS = [
    ...
    # --- 5 additional scenarios for statistical robustness ---
    {
        "id": "perfectionism",
        "description": "Perfectionism blocking progress",
        "turns": [
            "我想聊聊我的完美主義，它讓我什麼事都做不完。",
            "對，每次寫報告都要改很多遍，最後反而交不出去。",
            "嗯...好像覺得如果不完美，就代表我不夠好。",
            "其實從小我媽就是這樣要求我的，考 98 分她會問那 2 分去哪了。",
            "也許...完美不是目標，完成才是。",
            "我想我可以練習先交初稿，不管完不完美。",
            "這禮拜五之前，先交一份 80 分的報告出去。",
            "最大的障礙是自己心裡那個聲音，一直說不夠好。",
        ],
    },
    {
        "id": "people_pleasing",
        "description": "Cannot say no to others",
        "turns": [
            "我今天想談的是...我好像沒辦法拒絕別人。",
            "對，不管誰來找我幫忙，我都會答應，即使自己已經很累了。",
            "嗯...因為我怕拒絕之後他們就不喜歡我了。",
            "好像一直覺得自己要「有用」，別人才會需要我。",
            "哇...你這樣一說，我發現我把「被需要」跟「被愛」搞混了。",
            "我想開始練習說「不」，從小事開始。",
            "明天同事再請我幫忙加班的時候，我就試著說「我今天沒辦法」。",
            "可能會很不舒服，但我想試試看。",
        ],
    },
    {
        "id": "parent_expectation",
        "description": "Living under parent expectations",
        "turns": [
            "我想聊一下我爸對我的期待，壓得我喘不過氣。",
            "他一直覺得我應該考公務員，但我想做設計。",
            "每次跟他提，他就說我不切實際，然後我就不敢說了。",
            "嗯...好像不只是職業選擇，而是我一直在活他想要的人生。",
            "對...我好像從來沒有問過自己真正想要什麼。",
            "也許...我需要跟他好好談一次，告訴他我的想法。",
            "這個週末吧，找個他心情好的時候。",
            "可能的障礙是他又生氣，但這次我想堅持說完。",
        ],
    },
    {
        "id": "burnout_recovery",
        "description": "Recovering from burnout",
        "turns": [
            "我最近被診斷出職業倦怠，醫生叫我休息，但我不知道怎麼休息。",
            "就是...一停下來就會焦慮，覺得自己在浪費時間。",
            "嗯，好像停下來就代表我很懶，很沒用。",
            "對，其實從小就被教導要努力，休息是不負責任的。",
            "所以...我其實不是不會休息，是不「允許」自己休息。",
            "我想我可以先從每天留 30 分鐘給自己開始。",
            "今天回去就開始，每天下班後 30 分鐘不看手機。",
            "最大的障礙是...可能會有人找我，我怕漏接重要的事。",
        ],
    },
    {
        "id": "team_conflict",
        "description": "Conflict with team member",
        "turns": [
            "我想談一下我跟同事小李的衝突，已經影響到工作了。",
            "他做事很慢，每次都拖到 deadline，害我要幫他收拾。",
            "嗯...其實我不是生他的氣，我是生自己的氣，因為我不敢跟他說。",
            "對，好像一直以來我都是那個「配合」的人，從來不表達不滿。",
            "也許...我需要的不是他改變，而是我自己學會設界線。",
            "我想我可以找個時間，直接告訴他我的感受。",
            "下禮拜一，在週會之前，我先跟他一對一談。",
            "障礙是...我怕他覺得我在針對他，影響關係。",
        ],
